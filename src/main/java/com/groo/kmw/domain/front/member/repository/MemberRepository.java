...
//    Member findByGetMemberLoginId(String memberLoginId);
    ...
    Optional<Member>findByMemberNameAndMemberBirthDateAndMemberEmail(String memberName, LocalDate memberBirthDate, String memberEmail);

    Optional<Member>findByMemberNameAndMemberLoginIdAndMemberEmail(String memberName, String memberLoginId, String memberEmail);
}
